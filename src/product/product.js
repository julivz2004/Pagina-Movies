        ...
        <div className="description">
         ...
         <div className="galery">
            {imgdata.map((url, index) => (
              <img key={index} src={url} alt={`imagen-${index}`} onClick={() => handleGalleryClick(index)} />
            ))}
          </div>
            
            <div className="slider">
                <div className="left" onClick={contador < 1 ? null : slideLeft}>
                ...
                <div className="rigth" onClick={contador == imgdata.length-1 ? null : slideRight}>
                <FontAwesomeIcon icon={faAngleRight} className="fa-rigth" />
                </div>
